...
alter table "public"."invite_tokens" add column "datas" jsonb not null default '{}'::jsonb;
...
begin
  ...
  if invite_token is not null then
    select datas into invite_data from public.invite_tokens where token = invite_token;
  end if;
